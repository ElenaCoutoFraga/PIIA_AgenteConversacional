...
Para ejecutar el proyecto basta con hacer un <docker compose up> desde la carpeta _TresPi_ y después entrar al _localhost:8770_ para acceder a la interfaz gráfica.
